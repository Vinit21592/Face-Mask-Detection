import os,sys
import yaml
from maskDetection.utils.main_utils import read_yaml_file
from maskDetection.logger import logging
from maskDetection.exception import MaskException
from maskDetection.entity.config_entity import ModelTrainerConfig
from maskDetection.entity.artifact_entity import ModelTrainerArtifact
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self,)->ModelTrainerArtifact:
        ...
        try:
            ...
            os.system("unzip Mask_data.zip") 
            os.system("rm Mask_data.zip")
